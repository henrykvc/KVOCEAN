...
export const DEFAULT_CLASSIFICATION_GROUPS: ClassificationGroups = {
  ...
  매도가능증권: ["매도가능증권"],
  단기대여금: ["단기대여금", "단기대여금_양수", "단기대여금_주주임원종업원", "단기대여금_기타", "단기대여금_음수"],
  "개발비(자산)": ["개발비(자산)", "개발비", "개발비_양수", "개발비_음수"],
  선급금: ["선급금", "선급금_양수", "선급금_음수"],
  가수금: ["가수금"],
  가지급금: ["가지급금"],
  퇴직급여충당부채: ["퇴직급여충당부채", "퇴직급여충당부채_양수", "확정급여채무", "퇴직급여충당부채_음수", "사외적립자산", "단기종업원부채_퇴직급여", "장기종업원부채_퇴직급여"],
  매출채권: ["매출채권", "매출채권_양수", "외상매출금", "장기매출채권", "매출채권_음수", "매출채권_대손충당금", "장기매출채권_대손충당금", "매출채권_현할차", "장기매출채권_현할차"],
  미수금: ["미수금", "미수금_음수", "미수금_대손충당금", "미수금_정부보조금"],
  미수수익: ["미수수익", "미수수익_음수", "미수수익_대손충당금"],
  재고자산: [
    "재고자산",
    "상품",
    "상품_재고충당금",
